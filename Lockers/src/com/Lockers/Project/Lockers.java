	...
	public class Lockers {
	    ...
	    void showSecondaryMenu() {
	        ...
	        try{
	            ...
	            switch (option){
	                case 'a' : {
	                    System.out.print("Ã¢â€ Â³ Adding a file...Please Enter a File Name : ");
	                    String filename = scanner.next().trim().toLowerCase();
	                    addFile(filename);
	                    break;
	                }
	                case 'b' : {
	                    System.out.print("Ã¢â€ Â³ Deleting a file...Please Enter a File Name : ");
	                    String filename = scanner.next().trim();
	                    deleteFile(filename);
	                    break;
	                }
	                case 'c' : {
	                    System.out.print("Ã¢â€ Â³ Searching a file...Please Enter a File Name : ");
	                    String filename = scanner.next().trim();
	                    searchFile(filename);
	                    break;
	                }
